...
public class TestJerseyMultipartGedcomxFileWriter {
  ...
  public void testWriteMoreComplexObjects() throws Exception {
    ...
    cid = writer.addPart(RecordModel.GEDCOMX_RECORD_V1_XML_MEDIA_TYPE, person);
    person.setId(cid);
    ...
    cid = writer.addPart(RecordModel.GEDCOMX_RECORD_V1_XML_MEDIA_TYPE, relationship);
    ...
    assertEquals(RecordModel.GEDCOMX_RECORD_V1_XML_MEDIA_TYPE, personPart.getContentType());
    ...
    assertEquals(RecordModel.GEDCOMX_RECORD_V1_XML_MEDIA_TYPE, relationshipPart.getContentType());
