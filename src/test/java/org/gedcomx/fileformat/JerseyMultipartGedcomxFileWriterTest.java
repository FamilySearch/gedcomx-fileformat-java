 ...
 */
@Test
public class JerseyMultipartGedcomxFileWriterTest {
  ...
  public void testWriteMoreComplexObjects() throws Exception {
    ...
    String cid = writer.addPart(RecordModel.GEDCOMX_RECORD_V1_XML_MEDIA_TYPE, record);
    record.setId(cid);

    Person person = new Person();
    URI personPersistentId = URI.create("person_pid");
    person.setPersistentId(personPersistentId);
    cid = writer.addPart(ConclusionModel.GEDCOMX_CONCLUSION_V1_XML_MEDIA_TYPE, person);
    person.setId(cid);
    ...
    cid = writer.addPart(ConclusionModel.GEDCOMX_CONCLUSION_V1_XML_MEDIA_TYPE, relationship);
    ...
    assertEquals(RecordModel.GEDCOMX_RECORD_V1_XML_MEDIA_TYPE, recordPart.getContentType());
    ...
    assertEquals(ConclusionModel.GEDCOMX_CONCLUSION_V1_XML_MEDIA_TYPE, personPart.getContentType());
    ...
    assertEquals(ConclusionModel.GEDCOMX_CONCLUSION_V1_XML_MEDIA_TYPE, relationshipPart.getContentType());
